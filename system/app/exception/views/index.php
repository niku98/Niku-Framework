		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="tab-content vertical">
					...
					<?php endforeach; ?>
					<div class="px-3 pt-3" style="word-wrap: break-word;">
						...
						<?php foreach (Request::all() as $name => $value): ?>
							<p class="m-0 py-2 border-top small"><b><?= $name ?>: </b><?= !empty($value) ? $value : 'NULL' ?></p>
						<?php endforeach; ?>

						<h5 class="font-weight-normal mb-4 mt-5">Server data:</h5>

						<?php foreach (Request::server() as $name => $value): ?>
							<p class="m-0 py-2 border-top small"><b><?= $name ?>: </b><?= $value ?></p>
						<?php endforeach; ?>
					</div>
				</div>
			</div>
